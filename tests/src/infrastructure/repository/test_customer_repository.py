...
class TestCustomerRepository:
    ...
    def test_create_customer_success(self):
        ...
        user = UserFactory()
        customer = Customer(person=person_model.to_entity(), user=user.to_entity())
    ...
    def test_create_customer_with_person_when_the_person_is_not_registered(self):
        ...
        assert created_customer.id is not None
        assert created_customer.person.name == person.name
        assert created_customer.person.cpf == person.cpf
        assert created_customer.person.email == person.email
        assert created_customer.person.birth_date == person.birth_date
        assert created_customer.user.id == user.id
    ...
    def test_delete_customer_unregistered_id(self):
        ...
        person = PersonFactory()
        user = UserFactory()
        unregistered_customer = Customer(person=person.to_entity(), user=user.to_entity())
